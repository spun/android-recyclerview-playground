package com.spundev.activitysharedelements.adapter
...
import com.spundev.activitysharedelements.R
...
class GridAdapter internal constructor(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        val itemView = inflater.inflate(R.layout.ase_recyclerview_item, parent, false)
