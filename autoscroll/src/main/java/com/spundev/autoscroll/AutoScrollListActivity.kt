...
import com.spundev.autoscroll.adapter.AutoScrollListAdapter
...
class AutoScrollListActivity : AppCompatActivity() {

    private lateinit var binding: AscAutoScrollActivityBinding

    private lateinit var layoutManager: LinearLayoutManager
    private lateinit var adapter: AutoScrollListAdapter
    ...
    private fun prepareRecyclerView() {
        ...
        // Create adapter
        adapter = AutoScrollListAdapter(this,
            onClick = { item ->
    ...
    companion object {
        fun start(context: Context) {
            val starter = Intent(context, AutoScrollListActivity::class.java)
